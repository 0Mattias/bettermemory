...
- You're on Claude Code without the [plugin](../plugin/README.md) (the plugin ships the same content as a `SKILL.md` that loads without Claude Code's ~1.8 KB `instructions` truncation), or
