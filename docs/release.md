...
Writing the entry in prose that reuses the commits' own phrasing is what clears tier 2 for most of a window; reach for a SHA citation only where a bullet intentionally covers several commits at once.
