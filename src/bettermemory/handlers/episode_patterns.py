...
DESC_EPISODE_PATTERNS = (
    ...
    "episode_ids, episode_count, distinct_sessions, snippets, "
    "snippets_shown}` per pattern. `snippets` is CAPPED, so compare "
    "`snippets_shown` against `episode_count` before promoting: "
    "promote deletes every member, and on a large cluster you are "
    "judging a fraction of what you delete.\n"
