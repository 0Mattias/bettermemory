...
DESC_EPISODE_SEARCH = (
    ...
    "Rows are oldest-first INSIDE the most-recent-`max_results` "
    "window: over the cap it keeps the MOST-RECENT N, so 'what did I "
    "conclude lately?' reads the tail, not the head.\n\n"
