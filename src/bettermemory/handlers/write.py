...
DESC_MEMORY_WRITE = (
    ...
    "`path`, `path::symbol`, `path::NAME=literal`, `!path` (absent). "
    "Checked against the worktree NOW (false ⇒ refused); drift "
    "watches the claimed bindings, not whole files. Declare when "
    "citing code.\n"
