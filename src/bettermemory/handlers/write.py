...
DESC_MEMORY_WRITE = (
    ...
    "guardrails below catch bad writes. Triggers → category: a user "
    "preference (→ user-inference); a project decision you concurred "
    "with (→ fact); a tool / infra / config fact, or a finished unit "
    "of work with a why git won't capture (→ fact). (Full policy: the "
