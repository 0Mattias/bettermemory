...
DESC_MEMORY_CURATE = (
    ...
    "dead-weight facts — last touched before the window, retrieved at "
    "least once (earliest retrieval past the 2-day grace), never applied, "
    "no unresolved contradiction — to the ambient category (undo via "
