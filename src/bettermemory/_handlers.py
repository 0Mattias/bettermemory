...
DESC_MEMORY_SEARCH = (
    ...
    "spot_check_required) — rolled-up signal across calendar, "
    "path, and commit drift. When != fresh, spot-check a claim "
    "before relying; memory_verify(id, …) if it holds, "
    "memory_update first if it drifted.\n"
    "- `match_terms` — which query words actually hit.\n"
    "- `path_drift_missing` (int) — body cites paths that no "
    "longer exist; non-zero is a cue to expand.\n"
...
DESC_MEMORY_WRITE = (
    ...
    "Return statuses:\n"
    "- `ok` — committed; payload carries the new id and `related` "
    "medium-overlap matches.\n"
